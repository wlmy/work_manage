...
@section('content')
    <div class="member-box">
        ...
        <div class="box-body">
            <form role="form" class="form-horizontal col-sm-5" method="post" action="{{route('workLog.create')}}" id="log-form">
                ...
                <div id="daily" hidden>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="todayFinished" id="todayFinished" maxlength="20" placeholder="" value="{{$log->today_finished}}">
                    </div>
                    <div class="form-group">
                        <label for="todayUnFinished">未完成工作</label><strong class="text-danger">*</strong>
                        <input type="text" class="form-control" name="todayUnFinished" id="todayUnFinished" maxlength="20" placeholder="" value="{{$log->today_unfinished}}">
                    </div>
                    <div class="form-group">
                        <label for="todayConcerted">需协调工作</label>
                        <input type="text" class="form-control" name="todayConcerted" id="todayConcerted" maxlength="20" placeholder="" value="{{$log->concerted}}">
                    </div>
                </div>
                ...
                <div id="week" hidden>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="weekFinished" id="weekFinished" maxlength="20" placeholder="" value="{{$log->week_finished}}">
                    </div>
                    <div class="form-group">
                        <label for="weekSummary">本周工作总结</label><strong class="text-danger">*</strong>
                        <input type="text" class="form-control" name="weekSummary" id="weekSummary" maxlength="20" placeholder="" value="{{$log->week_summary}}">
                    </div>
                    <div class="form-group">
                        <label for="nextWeekPlan">下周工作计划</label><strong class="text-danger">*</strong>
                        <input type="text" class="form-control" name="nextWeekPlan" id="nextWeekPlan" maxlength="20" placeholder="" value="{{$log->next_week_plan}}">
                    </div>
                    <div class="form-group">
                        <label for="weekConcerted">需协调与帮助</label>
                        <input type="text" class="form-control" name="weekConcerted" id="weekConcerted" maxlength="20" placeholder="" value="{{$log->concerted}}">
                    </div>
                </div>
                ...
                <div id="month" hidden>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="monthFinished" id="monthFinished" maxlength="20" placeholder="" value="{{$log->month_finished}}">
                    </div>
                    <div class="form-group">
                        <label for="monthSummary">本月工作总结</label><strong class="text-danger">*</strong>
                        <input type="text" class="form-control" name="monthSummary" id="monthSummary" maxlength="20" placeholder="" value="{{$log->month_summary}}">
                    </div>
                    <div class="form-group">
                        <label for="nextMonthPlan">下月工作计划</label><strong class="text-danger">*</strong>
                        <input type="text" class="form-control" name="nextMonthPlan" id="nextMonthPlan" maxlength="20" placeholder="" value="{{$log->next_month_plan}}">
                    </div>
                    <div class="form-group">
                        <label for="monthConcerted">需帮助与支持</label>
                        <input type="text" class="form-control" name="monthConcerted" id="monthConcerted" maxlength="20" placeholder="" value="{{$log->concerted}}">
                    </div>
                </div>
                ...
                <div id="year" hidden>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="yearTarget" id="yearTarget" maxlength="20" placeholder="" value="{{$log->year_target}}">
                    </div>
                    <div class="form-group">
                        <label for="yearPlan">关键计划</label><strong class="text-danger">*</strong>
                        <input type="text" class="form-control" name="yearPlan" id="yearPlan" maxlength="20" placeholder="" value="{{$log->year_plan}}">
                    </div>
                    <div class="form-group">
                        <label for="yearFinishSituation">完成情况</label><strong class="text-danger">*</strong>
                        <input type="text" class="form-control" name="yearFinishSituation" id="yearFinishSituation" maxlength="20" placeholder="" value="{{$log->year_plan_finished_situation}}">
                    </div>
                </div>

                <div class="form-group">
                    <label for="remark">备注</label>
                    <textarea class="form-control" rows="3" title="描述" name="remark" id="remark" maxlength="500">{{$log->remark}}</textarea>
                </div>
                <div class="form-group">
